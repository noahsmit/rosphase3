...
class SrdfStateToMoveitAriac(EventState):
	...
	#> joint_values		float[]		    Target configuration of the joints.
        ...
        def __init__(self):
                ...
                Constructor
                '''
                super(SrdfStateToMoveitAriac, self).__init__(outcomes=['reached', 'planning_failed', 'control_failed', 'param_error'],
							input_keys = ['config_name', 'move_group', 'namespace', 'action_topic', 'robot_name'],
        ...
        def on_enter(self, userdata):
                ...
                self._action_topic = userdata.namespace + userdata.action_topic
                ...
                if rospy.has_param(userdata.namespace + '/robot_description_semantic'):
                        self._srdf_param = rospy.get_param(userdata.namespace + '/robot_description_semantic')
                else:
